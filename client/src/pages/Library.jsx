...
const Library = () => {
  const categories = [
    { id: 'nutrition', title: 'Nutrition', desc: 'Essential vitamins, diet plans, and safe foods for you and your baby.', articles: 12, icon: Utensils, color: 'text-mamacare-teal', bg: 'bg-teal-50' },
    { id: 'safety', title: 'Pregnancy Safety', desc: 'Navigating everyday activities, travel, and medications safely.', articles: 8, icon: Shield, color: 'text-red-400', bg: 'bg-red-50' },
    { id: 'mental', title: 'Mental Health', desc: 'Mindfulness, postpartum wellness, and managing emotional shifts.', articles: 15, icon: Brain, color: 'text-orange-400', bg: 'bg-orange-50' },
    { id: 'fetal', title: 'Fetal Development', desc: 'Understanding how your baby grows month by month.', articles: 9, icon: Baby, color: 'text-blue-400', bg: 'bg-blue-50' },
  ];
    ...
    <div className="min-h-screen bg-[#FAFAFA] font-outfit pb-20">
      ...
      <main className="pt-32 px-4 md:px-8 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          {/* Main Hero Article (8/12) */}
          <div className="lg:col-span-8 relative group cursor-pointer overflow-hidden rounded-[3rem] shadow-2xl h-[600px]">
            <img 
              src="https://images.unsplash.com/photo-1544126592-807daa2b569b?auto=format&fit=crop&q=80&w=2000" 
            ...
            <div className="absolute bottom-0 left-0 p-12 md:p-16 space-y-6 max-w-2xl">
              ...
              <h2 className="text-5xl font-bold text-white leading-[1.1] tracking-tight">
                Safe Sleep Positions during the Third Trimester
              </h2>
              <p className="text-white/70 text-lg leading-relaxed font-medium">
                Optimizing your rest is crucial as you approach delivery. Learn the recommended positions for safety and comfort.
              </p>
